...
router
    ...
    .post([middlewares_1.default.categoryValidator], categoryController.createCategoryFromService);
router
    .route("/:id")
    .get(categoryController.getACategoryById)
    .put([middlewares_1.default.categoryValidator], categoryController.updateCategory)
